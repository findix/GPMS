		...
		<div id="main" class="clearfix">
			...
			<div class="container bs-docs-container">
				...
				<!-- 		<table class="table table-bordered">
					...
					<div class="col-xs-4">
					学号：<input type="text" class="form-control" name="tno"/><br/>					 
					...
					专业：<select><option selected="selected">软件工程</option><option>信息安全</option><option>计算机科学与技术</option></select><br/><br/>
